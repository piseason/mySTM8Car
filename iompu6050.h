...
//IO操作函数	 
	...
	#define READ_SDA  ((GPIOB->IDR & GPIO_PIN_5) != 0)	/* 读SDA口线状态 */
...
#define SET_SCL_OUT()    {GPIO_Init(GPIOB, GPIO_PIN_4, GPIO_MODE_OUT_OD_HIZ_FAST);}
#define SET_SDA_OUT()    {GPIO_Init(GPIOB, GPIO_PIN_5, GPIO_MODE_OUT_OD_HIZ_FAST);}
